...
const Portfolio = () => {
	...
	return (
		<div className="h-auto bg-first overflow-hidden items-center" id="Portfolio">
			<div className="w-3/5 bg-second h-10 -skew-x-[45deg] -translate-x-5 "></div>
			<div className="relative w-full md:max-w-[650px] lg:max-w-[1000px] xl:max-w-[1300px] flex items-center flex-col mx-auto py-6 pb-12 px-5">
				...
				<Swiper
					...
					className="w-full h-auto relative p-5 bg-third rounded-lg lg:w-[750px]">
					{projects.map((project, i) => (
						<SwiperSlide
							key={i}
							className="w-full h-[550px] text-lg flex flex-col p-4 mr-auto bg-first rounded-lg md:h-[600px] lg:h-[650px]">
							<div className="flex flex-col rounded-t-lg overflow-hidden">
								...
								<div className="flex flex-col">
									<h3 className="text-2xl font-semibold text-fourth mt-5 md:text-3xl">{project.title}</h3>
									<p className="text-sm mt-2 md:text-base">{project.description}</p>
								</div>
								<div className=" absolute bottom-5 mt-5 uppercase">
									<a
										href={project.demo}
										className="px-3 py-1 border border-gray-400 rounded hover:border-fourth hover:text-fourth md:text-lg md:px-4 md:py-1.5">
										Demo
									</a>
									<a
										href={project.github}
										className="px-3 py-1 ml-2 border border-gray-400 rounded hover:border-fourth hover:text-fourth md:text-lg md:px-4 md:py-1.5">
										github
									</a>
								</div>
							</div>
