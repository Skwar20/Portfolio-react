...
const AboutUs = () => {
	...
	return (
		<div className="w-full h-auto bg-second overflow-hidden" id="About">
			...
			<div className="relative w-full md:max-w-[650px] lg:max-w-[850px] xl:max-w-[1100px] mx-auto flex items-center flex-col py-6 px-4">
				...
				<p className="mt-5 md:text-base xl:text-lg">
				...
				<div className="w-full mt-4 mb-4 text-lg font-medium transition-all flex items-center justify-evenly lg:justify-start md:mt-5">
					<button
