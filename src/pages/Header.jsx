...
const Home = () => {
	return (
		<div
			...
			id="Home">
			<p className="p-1 text-2xl uppercase bg-slate-200 text-black font-semibold md:text-4xl lg:text-5xl xl:text-6xl">
				Hello, I'am
			</p>
			<h1 className="text-2xl uppercase text-fourth font-bold md:text-5xl lg:text-5xl xl:text-6xl">
				Frontend Developer
			</h1>
			<div className="text-gray-500/20 uppercase text-sm px-8 mt-7">
				<BiCode className="text-2xl  md:text-3xl" />
				<p className="font-bold ml-5 md:text-base">programming and creating websites is my passion</p>
